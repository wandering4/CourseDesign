...
public class PrizeGameReceiver {
    ...
    public void processMessage(String message) throws JsonProcessingException {
        ...
        //拦截相同项
        QueryWrapper<CardUserGame> queryWrapper = new QueryWrapper<>();
        queryWrapper.eq("userid", cardUserGame.getUserid()).eq("gameid", cardUserGame.getGameid());
        if (cardUserGameService.getOne(queryWrapper) ==null)
